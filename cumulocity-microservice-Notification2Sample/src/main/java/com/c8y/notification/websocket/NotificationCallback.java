package com.c8y.notification.websocket;
...
public interface NotificationCallback {
	 ...
	 */
	void onOpen(String tenantId, URI serverUri);
	 ...
	 */
	void onNotification(String tenantId, Notification notification);
